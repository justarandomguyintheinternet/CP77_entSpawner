...
#define __ID3D12CommandQueueDownlevel_INTERFACE_DEFINED__
    ...
    ID3D12CommandQueueDownlevel : IUnknown
    {
        virtual HRESULT STDMETHODCALLTYPE Present(
            _In_ ID3D12GraphicsCommandList * pOpenCommandList, _In_ ID3D12Resource * pSourceTex2D, _In_ HWND hWindow, D3D12_DOWNLEVEL_PRESENT_FLAGS Flags) = 0;
    };
    ...
    typedef struct ID3D12CommandQueueDownlevelVtbl
    {
        ...
        (ID3D12CommandQueueDownlevel* This, REFIID riid, _COM_Outptr_ void** ppvObject);

        ULONG(STDMETHODCALLTYPE* AddRef)(ID3D12CommandQueueDownlevel* This);

        ULONG(STDMETHODCALLTYPE* Release)(ID3D12CommandQueueDownlevel* This);

        HRESULT(STDMETHODCALLTYPE* Present)
        (ID3D12CommandQueueDownlevel* This, _In_ ID3D12GraphicsCommandList* pOpenCommandList, _In_ ID3D12Resource* pSourceTex2D, _In_ HWND hWindow,
...
#define ID3D12CommandQueueDownlevel_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define ID3D12CommandQueueDownlevel_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ID3D12CommandQueueDownlevel_Release(This) ((This)->lpVtbl->Release(This))

#define ID3D12CommandQueueDownlevel_Present(This, pOpenCommandList, pSourceTex2D, hWindow, Flags) ((This)->lpVtbl->Present(This, pOpenCommandList, pSourceTex2D, hWindow, Flags))
...
#define __ID3D12DeviceDownlevel_INTERFACE_DEFINED__
    ...
    ID3D12DeviceDownlevel : IUnknown
    {
        virtual HRESULT STDMETHODCALLTYPE QueryVideoMemoryInfo(
            UINT NodeIndex, DXGI_MEMORY_SEGMENT_GROUP MemorySegmentGroup, _Out_ DXGI_QUERY_VIDEO_MEMORY_INFO * pVideoMemoryInfo) = 0;
    };
    ...
    typedef struct ID3D12DeviceDownlevelVtbl
    {
        ...
        HRESULT(STDMETHODCALLTYPE* QueryInterface)
        (ID3D12DeviceDownlevel* This, REFIID riid, _COM_Outptr_ void** ppvObject);

        ULONG(STDMETHODCALLTYPE* AddRef)(ID3D12DeviceDownlevel* This);

        ULONG(STDMETHODCALLTYPE* Release)(ID3D12DeviceDownlevel* This);

        HRESULT(STDMETHODCALLTYPE* QueryVideoMemoryInfo)
        (ID3D12DeviceDownlevel* This, UINT NodeIndex, DXGI_MEMORY_SEGMENT_GROUP MemorySegmentGroup, _Out_ DXGI_QUERY_VIDEO_MEMORY_INFO* pVideoMemoryInfo);
...
#define ID3D12DeviceDownlevel_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define ID3D12DeviceDownlevel_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ID3D12DeviceDownlevel_Release(This) ((This)->lpVtbl->Release(This))
